                    ...
                    <div class="profile-tab-nav border-right">
                        ...
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link active" id="account-tab" data-toggle="pill" href="#account" role="tab"
                                aria-controls="account" aria-selected="true"><i class="fa fa-home text-center mr-1"></i>
                                Profile</a>
                        ...
                        <div class="tab-content p-4 p-md-7" id="v-pills-tabContent">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="institution" name="institution" class="form-control"
                                                value="<?php echo $out['institution'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="two-fact-auth"
                                                    value="<?php echo $out['two-fact-auth'];?>" id="two-fact-auth">
                            ...
                            <div class="tab-pane fade" id="featured" role="tabpanel" aria-labelledby="featured-tab">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Featured Skillset</label>
                                            <input type="text" id="featured1" name="featured1" class="form-control"
                                                value="<?php echo $out['featured1'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Featured Experience</label>
                                            <input type="text" id="featured2" name="featured2" class="form-control"
                                                value="<?php echo $out['featured2'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Featured Achievement</label>
                                            <input type="text" id="featured3" name="featured3" class="form-control"
                                                value="<?php echo $out['featured3'];?>">
                                        </div>
                                    </div>
                                </div>
                                <div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="skill1" name="skill1" class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="skill2" name="skill2" class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="skill3" name="skill3" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="edumate" name="edumate" class="form-control"
