		...
		<div class="lower-three-quarters">
			<div class="left-column">
				<div class="experience">
					...
					<!-- bold -->
					<ul>
						<li><h4><?php echo $out['featured1'];?></h4></li>
						<li><h4><?php echo $out['featured2'];?></h4></li>
						<li><h4><?php echo $out['featured3'];?></h4></li>
					</ul>
				</div>
				...
				<div class="experience">
					...
					<!-- bold -->
					<ul>
						<li><h3><?php echo $out['github'];?></h3></li>
						<li><h3><?php echo $out['linkedin'];?></h3></li>
						<li><h3><?php echo $out['edumate'];?></h3></li>
						<li><h3><?php echo $out['website'];?></h3></li>
					</ul>
				</div>
