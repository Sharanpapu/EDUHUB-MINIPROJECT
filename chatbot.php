<?php
    ...
    if(isset($_POST['ask']))
    {
      $qn=$_POST['qn'];
      $ans;
      $sql = "SELECT answer from chatbot where question like $qn";
      $ans = $conn->query($sql);
      }
...
<div class="chatbot chatbot--closed ">
  <div class="chatbot__header">
    <p><strong>Eduhub</strong> <span class="u-text-highlight">Need help?</span></p>
    ...
    <ul class="chatbot__messages">
      <li class="is-ai animation">
        ...
        <p class='chatbot__message'>
          <strong class='intro'><?php echo $ans;?></strong></p>
      </li>
      <!-- Message here -->
    </ul>
  </div>
  ...
  <div class="chatbot__entry chatbot--closed">
    <input type="text" class="chatbot__input"  name="qn" placeholder="Write a message..." />
    <button name="ask">
